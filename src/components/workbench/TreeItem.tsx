...
export default function TreeItem({
  ...
  return (
    <div
      ...
      className={`ml-1 flex items-center px-2 py-1 cursor-pointer rounded-sm text-xs transition-all relative ${active
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        {onToggleVisibility && (
          <button
            ...
            className={`p-0.5 rounded hover:bg-slate-200 transition-colors ${isVisible === false
              ? "text-slate-300"
