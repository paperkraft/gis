...
export function generateINP(features: Feature[]): string {
    ...
    lines.push('PATTERN            1'); // Default pattern
    lines.push('');
    ...
    // Pattern 1: Standard Diurnal Curve
    lines.push('1     0.5 0.5 0.6 0.7 0.8 0.9 1.1 1.3 1.4 1.3 1.2 1.1');
    lines.push('1     1.1 1.0 1.0 1.1 1.3 1.5 1.3 1.1 0.9 0.7 0.6 0.5');
    lines.push('');
